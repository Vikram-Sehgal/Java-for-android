 ...
 * <p>
 * The assignments are designed this way to simplify your early Android
 * interactions. Designing the assignments this way allows you to first learn
 * key 'Java' features without having to beforehand learn the complexities of
 * Android.
 *
 */
public class Logic implements LogicInterface {
    /**
     * This is a String to be used in Logging (if/when you decide you need it for
     * debugging).
     */
    public static final String TAG = Logic.class.getName();

    /*
     * This is the variable that stores our OutputInterface instance. <p> This is
     * how we will interact with the User Interface [MainActivity.java]. <p> It is
     * called 'out' because it is where we 'out-put' our results. (It is also the
     * 'in-put' from where we get values from, but it only needs 1 name, and 'out'
     * is good enough)
     */
    private OutputInterface mOut;

    /**
     * These are the numeric values that you will receive from the User Interface
     * and use in your calculations.
     */
    ...
    /**
     * This is the method that will (eventually) get called when the on-screen
     * button labeled 'Process...' is pressed.
     */
    @Override
    public void process() {
        ...
        switch (shapeForCalculations) {
            ...
            case Triangle:
                mOut.print(
                        "A right triangle with base " + mLength + " and height " + mHeight + " has a perimeter of: ");
                mOut.println("" + String.format("%.2f", rightTrianglePerimeter(mLength, mHeight)));
                mOut.println("");

                mOut.print("A right triangle with base " + mLength + " and height " + mHeight + " has area of: ");
                mOut.println("" + String.format("%.2f", rightTriangleArea(mLength, mHeight)));
                mOut.println("");
                break;
            default:
                break;
